...
import 'addprocedure3_model.dart';
export 'addprocedure3_model.dart';

class Addprocedure3Widget extends StatefulWidget {
...
class _Addprocedure3WidgetState extends State<Addprocedure3Widget> {
  late Addprocedure3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Addprocedure3Model());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await widget.customer!.update({
                      ...mapToFirestore(
                        {
                          'procedures': FieldValue.arrayUnion([
                            getProcedimentosFirestoreData(
                              createProcedimentosStruct(
