...
import 'addprocedure1_model.dart';
export 'addprocedure1_model.dart';

class Addprocedure1Widget extends StatefulWidget {
  const Addprocedure1Widget({super.key});

  @override
  State<Addprocedure1Widget> createState() => _Addprocedure1WidgetState();
}

class _Addprocedure1WidgetState extends State<Addprocedure1Widget> {
  late Addprocedure1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Addprocedure1Model());
