...
import 'viewprocedure1_model.dart';
export 'viewprocedure1_model.dart';

class Viewprocedure1Widget extends StatefulWidget {
  const Viewprocedure1Widget({
    super.key,
  ...
  @override
  State<Viewprocedure1Widget> createState() => _Viewprocedure1WidgetState();
}

class _Viewprocedure1WidgetState extends State<Viewprocedure1Widget> {
  late Viewprocedure1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Viewprocedure1Model());
            ...
            children: [
                              ...
                              children: [
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    isDense: true,
                                    labelText: 'Início do procedimento',
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    isDense: true,
                                    labelText:
                                        'Aviso de retorno (Em branco caso não seja necessário)',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
              ...
              Flexible(
                child: FFButtonWidget(
                  onPressed: () async {
                    FFAppState().removeFromProcedures(widget.procedure!);
                    safeSetState(() {});
                    Navigator.pop(context);
                  },
                  text: 'Excluir',
