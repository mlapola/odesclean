                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              await queryProceduresRecordOnce()
                                  .then(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Procurar procedimento',
                    ...
                    if (_model.textController2.text == '')
                      StreamBuilder<List<ProceduresRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ProceduresRecord> columnProceduresRecordList =
                              snapshot.data!;

                          return Column(
                            mainAxisSize: MainAxisSize.min,
                            children:
                                List.generate(columnProceduresRecordList.length,
                                    (columnIndex) {
                              final columnProceduresRecord =
                                  columnProceduresRecordList[columnIndex];
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Row(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: const Text(
                                                            'Tem certeza?'),
                                                        content: Text(
                                                            '${columnProceduresRecord.name} será excluido!'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                    ...
                    if (_model.textController2.text != '')
                      Builder(
                        builder: (context) {
                          final search2 = _model.simpleSearchResults2.toList();

                          return Column(
                            mainAxisSize: MainAxisSize.min,
                            children:
                                List.generate(search2.length, (search2Index) {
                              final search2Item = search2[search2Index];
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Row(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: const Text(
                                                            'Tem certeza?'),
                                                        content: Text(
                                                            '${search2Item.name} será excluido!'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
