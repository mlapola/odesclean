                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          ...
                                                          content: const Text(
                                                              'Parece que um erro ocorreu, verifique se todos os campos estão preenchidos e tente novamente'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Flexible(
                                                  child: StreamBuilder<
                                                      List<
                                                          ScheduleCampainRecord>>(
                                                    stream:
                                                        queryScheduleCampainRecord(),
                                                    builder:
                                                        (context, snapshot) {
                                                      // Customize what your widget looks like when it's loading.
                                                      if (!snapshot.hasData) {
                                                      ...
                                                      List<ScheduleCampainRecord>
                                                          listViewScheduleCampainRecordList =
                                                          snapshot.data!;
                                                      ...
                                                      return ListView.separated(
                                                        ...
                                                        itemBuilder: (context,
                                                            listViewIndex) {
                                                          final listViewScheduleCampainRecord =
                                                              listViewScheduleCampainRecordList[
                                                                  listViewIndex];
                                                          return Container(
                                                            width:
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        dateTimeFormat(
                                                                            "dd/M/yyyy H:mm",
                                                                            listViewScheduleCampainRecord.date!),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'Inter',
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (confirmDialogResponse) {
                                                                          await listViewScheduleCampainRecord
                                                                              .reference
                                                                              .delete();
                                                                        }
                                                                      },
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return SettingsWidget(
                                                          key: Key(
                                                              'Key6on_${columnIndex}_of_${columnSettingsRecordList.length}'),
                                                          parameter1:
